...
export const CompanyCreatePage = ({ isOverModal }: Props) => {
  ...
  return (
    <Modal
      ...
      width={512}
      closeIcon={<LeftOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
    >
      <Form
        {...formProps}
        layout="vertical"
          ...
          {(fields, { add, remove }) => (
            <Space direction="vertical">
                ...
                <Row key={key} gutter={12} align="middle">
                  <Col span={11}>
                    <Form.Item noStyle {...restField} name={[name, "name"]}>
                      <Input
                        addonBefore={<UserOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
                  ...
                  <Col span={11}>
                    <Form.Item noStyle name={[name, "email"]}>
                      <Input
                        addonBefore={<MailOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
              ...
              <Typography.Link onClick={() => add()}>
                <PlusCircleOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} /> Add new contacts
              </Typography.Link>
            </Space>
          )}
        </Form.List>
